    ...
    return (
        <>
            ...
            <div className="enterOtp">
                <DisplayNo />
                {/* <InputOtp /> */}
                <input type="tel" className="input_otp" placeholder="Enter 6 digit OTP" value={otp} onChange={handleChange} />
                <ResendCode />
                <button onClick={handleClick} className="otp_btn">Verify the code</button>
            </div>
        </>
    )
}